...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      current_session_user_id: { Args: never; Returns: string }
      has_role: {
        Args: {
      ...
      mint_session_token: { Args: { p_user_id: string }; Returns: string }
      verify_session_token: { Args: { p_token: string }; Returns: string }
    }
    Enums: {
      app_role: "admin" | "user"
    }
